  ...
  useEffect(() => {
    ...
    newArray.forEach((arr, i) => {
      arr.forEach((obj) => {
        ...
        const dateString = `${dateObject.getFullYear()}-${dateObject.getMonth() + 1}-${dateObject.getDate()} ${(dateObject.getUTCHours() > 12) ? dateObject.getUTCHours() - 12 + ' PM' : dateObject.getUTCHours() + ' AM'}`
